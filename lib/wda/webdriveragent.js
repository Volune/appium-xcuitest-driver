...
class WebDriverAgent {
  constructor (xcodeVersion, args = {}) {
    ...
    this.wdaRemotePort = this.realDevice ? WDA_AGENT_PORT : (this.wdaLocalPort || WDA_AGENT_PORT);
    this.mjpegServerPort = args.mjpegServerPort;
    this.updatedWDABundleId = args.updatedWDABundleId || WDA_RUNNER_BUNDLE_ID;
